...
from watchlist_app.api.views import (WatchListDetailAV,WatchListAV,StreamPlatformList,       StreamPlatformDetailAV,                               ReviewList, ReviewListAll, ReviewCreate,                                    ReviewDetail)
...
urlpatterns = [
    ...
    path('review/',ReviewListAll.as_view(),name='Review-List-All'),
